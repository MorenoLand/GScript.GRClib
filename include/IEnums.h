...
typedef enum PlayerPropId
{
	RC_PLPROP_NICKNAME		= 0,
	RC_PLPROP_MAXPOWER		= 1,
	RC_PLPROP_CURPOWER		= 2,
	RC_PLPROP_RUPEESCOUNT	= 3,
	RC_PLPROP_ARROWSCOUNT	= 4,
	RC_PLPROP_BOMBSCOUNT	= 5,
	RC_PLPROP_GLOVEPOWER	= 6,
	RC_PLPROP_BOMBPOWER		= 7,
	RC_PLPROP_SWORDPOWER	= 8,
	RC_PLPROP_SHIELDPOWER	= 9,
	RC_PLPROP_GANI			= 10,
	RC_PLPROP_HEADIMAGE		= 11,
	RC_PLPROP_CURCHAT		= 12,
	RC_PLPROP_COLORS		= 13,
	RC_PLPROP_ID			= 14,
	RC_PLPROP_X				= 15,
	RC_PLPROP_Y				= 16,
	RC_PLPROP_DIRECTION		= 17,
	RC_PLPROP_STATUS		= 18,
	RC_PLPROP_CARRYSPRITE	= 19,
	RC_PLPROP_CURLEVEL		= 20,
	RC_PLPROP_HORSEGIF		= 21,
	RC_PLPROP_HORSEBUSHES	= 22,
	RC_PLPROP_EFFECTCOLORS	= 23,
	RC_PLPROP_CARRYNPC		= 24,
	RC_PLPROP_APCOUNTER		= 25,
	RC_PLPROP_MAGICPOINTS	= 26,
	RC_PLPROP_KILLSCOUNT	= 27,
	RC_PLPROP_DEATHSCOUNT	= 28,
	RC_PLPROP_ONLINESECS	= 29,
	RC_PLPROP_IPADDR		= 30,
	RC_PLPROP_UDPPORT		= 31,
	RC_PLPROP_ALIGNMENT		= 32,
	RC_PLPROP_ADDITFLAGS	= 33,
	RC_PLPROP_ACCOUNTNAME	= 34,
	RC_PLPROP_BODYIMAGE		= 35,
	RC_PLPROP_RATING		= 36,
	RC_PLPROP_GATTRIB1		= 37,
	RC_PLPROP_GATTRIB5		= 41,
	RC_PLPROP_ATTACHNPC		= 42,
	RC_PLPROP_GMAPLEVELX	= 43,
	RC_PLPROP_GMAPLEVELY	= 44,
	RC_PLPROP_Z				= 45,
	RC_PLPROP_GATTRIB6		= 46,
	RC_PLPROP_GATTRIB9		= 49,
	RC_PLPROP_JOINLEAVELVL	= 50,
	RC_PLPROP_PCONNECTED	= 51,
	RC_PLPROP_PLANGUAGE		= 52,
	RC_PLPROP_PSTATUSMSG	= 53,
	RC_PLPROP_GATTRIB10		= 54,
	RC_PLPROP_GATTRIB30		= 74,
	RC_PLPROP_OSTYPE		= 75,
	RC_PLPROP_TEXTCODEPAGE	= 76,
	RC_PLPROP_UNKNOWN77		= 77,
	RC_PLPROP_X2			= 78,
	RC_PLPROP_Y2			= 79,
	RC_PLPROP_Z2			= 80,
	RC_PLPROP_UNKNOWN81		= 81,
	RC_PLPROP_COMMUNITYNAME	= 82
} PlayerPropId;

typedef enum NPCPropId
{
	RC_NPCPROP_NAME		= 50,
	RC_NPCPROP_TYPE		= 51,
	RC_NPCPROP_LEVEL	= 52
